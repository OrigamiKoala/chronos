          ...
          if (nextCh === 'n') {
            ...
            if (match) {
              ...
              const latexNCommands = new Set([
                'nu', 'neg', 'neq', 'notin', 'nexists', 'nearrow', 'nwarrow', 'nabla', 'natural', 
              ...
              const isCommonNCommand = latexNCommands.has(word) || word.startsWith('new') || word.startsWith('num') || word.startsWith('nright') || word.startsWith('nleft');
              if (!isCommonNCommand) {
                isLatex = false;
              }
            } else {
