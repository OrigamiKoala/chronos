...
export async function generateProblem(difficultyLevel, subject = "Math") {
    ...
    Syllabus Boundaries: For difficulty levels < 8, do NOT introduce advanced topics outside the high-school/national olympiad purview (e.g., avoid general relativity, quantum field theory, particle physics standard model, or advanced Hamiltonian/Lagrangian mechanics). For difficulty levels >= 8, you MAY introduce advanced outside, college, or graduate-level topics, BUT you must use a first-principles approach. You must assume the user knows absolutely nothing about the topic and define all non-standard concepts, equations, and phenomena from scratch within the problem text itself.
    Syllabus Boundaries: For difficulty levels < 8, do NOT introduce advanced topics outside the high-school/national olympiad purview (e.g., avoid general relativity, quantum field theory, particle physics standard model, or advanced Hamiltonian/Lagrangian mechanics). For difficulty levels >= 8, you MAY introduce advanced outside, college, or graduate-level topics, BUT you must use a first-principles approach. You must assume the user knows absolutely nothing about the topic and define all non-standard concepts, equations, and phenomena from scratch within the problem text itself.
    `;
    ...
    Syllabus Boundaries: For difficulty levels < 8, do NOT introduce advanced topics outside the high-school/national olympiad purview (e.g., avoid overpotential calculations involving the Tafel equation, Maxwell's relations, full molecular orbital symmetry point groups, or advanced spectroscopic methods like 2D-NMR). For difficulty levels >= 8, you MAY introduce advanced outside, college, or graduate-level topics, BUT you must use a first-principles approach. You must assume the user knows absolutely nothing about the topic and define all non-standard concepts, equations, and phenomena from scratch within the problem text itself.
    Syllabus Boundaries: For difficulty levels < 8, do NOT introduce advanced topics outside the high-school/national olympiad purview (e.g., avoid overpotential calculations involving the Tafel equation, Maxwell's relations, full molecular orbital symmetry point groups, or advanced spectroscopic methods like 2D-NMR). For difficulty levels >= 8, you MAY introduce advanced outside, college, or graduate-level topics, BUT you must use a first-principles approach. You must assume the user knows absolutely nothing about the topic and define all non-standard concepts, equations, and phenomena from scratch within the problem text itself.
