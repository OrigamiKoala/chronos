...
export const translations = {
  en: {
    ...
    faq: {
      ...
      question: 'Can you participate in both NHD and MATHCOUNTS?',
      answerEmphatic: 'Unfortunately, we are unable to accomodate students who wish to participate in both NHD and MATHCOUNTS this year. We request that students make a choice.',
  ...
  zh: {
    ...
    faq: {
      ...
      question: '可以同时参加 NHD 和 MATHCOUNTS 吗？',
      answerEmphatic: '很遗憾，今年我们无法兼顾希望同时参加 NHD 和 MATHCOUNTS 的学生。我们要求学生在二者之间做出选择。',
